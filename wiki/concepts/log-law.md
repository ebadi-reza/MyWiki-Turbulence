...
scale `δ_t = u_τ/ω`** (Akhavan et al. 1991a). Log behavior is expected whenever *at least two* of the three scales are widely separated, giving four scenarios ([[2016-ebadi-thesis]] Ch. 5) [source]:
